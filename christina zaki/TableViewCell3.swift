        ...
        Alamofire.request(
            ...
            , headers: nil).validate().responseJSON { (res) in
                ...
                if res.result.isSuccess {
                    ...
                    let hot_spots     =  data?["hot_spots"] as? [[String:Any]]
                   
                    for placeDictionary in hot_spots! {
                        let hot =  place( dictionary:placeDictionary)
                        self.places.append(hot)
                       
                    }
                    if let categories0    =  hot_spots?[0]["categories"]as? [[String:Any]] {
                          print("\(categories0)")
                    ...
                    if let categories1    =  hot_spots?[1]["categories"]as? [[String:Any]] {
                        print("\(categories1)")
                    ...
                    if let photo0    =  hot_spots?[0]["photos"]as? [String] {
                       
                        self.photoName0 = photo0[0] as! String
                        
                    }
                    if let photo1    =  hot_spots?[1]["photos"]as? [String] {
...
extension TableViewCell3 : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
